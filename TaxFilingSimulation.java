...
class Taxpayer extends Person implements Taxable {
    ...
    private double calculateSingleTax(double taxableIncome) {
        ...
        if (taxableIncome <= 12800) {
            ...
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (taxableIncome - 17650) * 0.0525; // 4% on first $12,800, 4.5% on next $4,850, 5.25% on the rest up to $20,900
        } else if (taxableIncome <= 107650) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (taxableIncome - 20900) * 0.055; // Continue with additional tax brackets for single filers
        } else if (taxableIncome <= 269300) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (taxableIncome - 107650) * 0.06;
        } else if (taxableIncome <= 1616450) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (269300 - 107650) * 0.06 + (taxableIncome - 269300) * 0.0685;
        } else if (taxableIncome <= 5000000) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (269300 - 107650) * 0.06 + (1616450 - 269300) * 0.0685 + (taxableIncome - 1616450) * 0.0965;
        } else if (taxableIncome <= 25000000) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (269300 - 107650) * 0.06 + (1616450 - 269300) * 0.0685 + (5000000 - 1616450) * 0.103 + (taxableIncome - 5000000) * 0.103;
        } else {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (269300 - 107650) * 0.06 + (1616450 - 269300) * 0.0685 + (5000000 - 1616450) * 0.103 + (25000000 - 5000000) * 0.109 + (taxableIncome - 25000000) * 0.109;
        }
    ...
    private double calculateJointTax(double taxableIncome) {
        ...
        if (taxableIncome <= 17150) {
            ...
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (taxableIncome - 23600) * 0.0525; // 4% on first $17,150, 4.5% on next $4,450, 5.25% on the rest up to $27,900
        } else if (taxableIncome <= 161550) {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (taxableIncome - 27900) * 0.055; // Continue with additional tax brackets for joint filers
        } else if (taxableIncome <= 323200) {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (161550 - 27900) * 0.055 + (taxableIncome - 161550) * 0.06;
        } else if (taxableIncome <= 2155350) {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (161550 - 27900) * 0.055 + (323200 - 161550) * 0.06 + (taxableIncome - 323200) * 0.0685;
        } else if (taxableIncome <= 5000000) {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (161550 - 27900) * 0.055 + (323200 - 161550) * 0.06 + (2155350 - 323200) * 0.0685 + (taxableIncome - 2155350) * 0.0965;
        } else if (taxableIncome <= 25000000) {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (161550 - 27900) * 0.055 + (323200 - 161550) * 0.06 + (2155350 - 323200) * 0.0685 + (5000000 - 2155350) * 0.103 + (taxableIncome - 5000000) * 0.103;
        } else {
            tax = 17150 * 0.04 + (23600 - 17150) * 0.045 + (27900 - 23600) * 0.0525 + (161550 - 27900) * 0.055 + (323200 - 161550) * 0.06 + (2155350 - 323200) * 0.0685 + (5000000 - 2155350) * 0.103 + (25000000 - 5000000) * 0.109 + (taxableIncome - 25000000) * 0.109;
        }
    ...
    private double calculateHeadOfHouseholdTax(double taxableIncome) {
        ...
        if (taxableIncome <= 12800) {
            ...
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (taxableIncome - 20900) * 0.055; // Continue with additional tax brackets for head of household filers
        } else if (taxableIncome <= 269300) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (taxableIncome - 107650) * 0.06;
        } else if (taxableIncome <= 1616450) {
            tax = 12800 * 0.04 + (17650 - 12800) * 0.045 + (20900 - 17650) * 0.0525 + (107650 - 20900) * 0.055 + (269300 - 107650) * 0.06 + (taxableIncome - 269300) * 0.0685;
